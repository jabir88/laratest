...
<div id="page-wrapper">
    ...
    <div class="row">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $one_token->deposit_amount }}
                            ...
                            <i style="color:#d81414;"><b>Amount Pending</b></i>
                            @else
        ...
        @if($one_token->token_status == 0)
        <div class="col-lg-12">
            <form action="{{route('tokensub.admin.sub')}}" method="post">
                @csrf
                <input type="hidden" name="cls_ticket" class="form-control-file" id="cls_ticket" value="{{ $one_token->id}}">

                <button type="submit" class="btn btn-success"> Closed Ticket </button>
            </form>
        </div>
        @endif
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <h4 style="font-weight : 700;">{{$auth->name}}</h4>
            @else
        ...
        <div class="col-lg-12">
            ...
            <form action="{{route('tokensub.reply')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="details" id="details" rows="5">{{ old('details') }}</textarea>
                    @error('details')
